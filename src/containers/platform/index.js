...
const Platform = () => {
  ...
  const mTopGmesAvgTblDta = React.useMemo(() => {
    ...
    for (let i = 0; i < platformData.topdata_average.length; i++) {
      ...
      row.index = i + 1 + ".";
      row.name = <Link to={"/" + prmSource + "/" + topGmeAvg.NameSEO}>{topGmeAvg.Name}</Link>;
  ...
  return (
    <>
      ...
      <div className="container">
            ...
            <div className="card-body p-0">
              <Table
                ...
                columnsDef={[
                  ...
                  {
                    target: 3,
                    className: "app-text-gray text-center",
                  },
                ]}
                emptyOpts={{
                  row: 10,
        ...
        <div className="row mt-3">
          <div className="card">
            ...
            <div className="card-body p-0">
              ...
              />
              <div className={"d-flex justify-content-end border-top py-1 px-3 " + cx("more")}>
                <Link className="btn btn-success btn-round " to={"/" + prmSource + "/player_count/1"}>
                  More
                </Link>
              </div>
            </div>
        ...
        <div className="row mt-3">
          <GameSlider loading={platformData.loading} data={platformData.topdata} store={prmSource} />
        </div>
        <div className="row mt-3">
          <div className="card">
            <div className="card-header bg-gradient-grey">
        ...
        <div className="row mt-3">
          <div className="card">
            ...
            <div className="card-body p-0">
              ...
              />
              <div className={"d-flex justify-content-end border-top py-1 px-3 " + cx("more")}>
                <Link className="btn btn-success btn-round" to={"/" + prmSource + "/player_average/1"}>
                  More
                </Link>
              </div>
            </div>
        ...
        <div className="row mt-3 pb-3">
          <GameSlider loading={platformData.loading} data={platformData.topdata_average} store={prmSource} />
        </div>
      </div>
    </>
  );
